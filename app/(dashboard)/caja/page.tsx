    ...
    <>
      <div>
        ...
        <p style={{ fontSize: 12, color: '#52525B', marginTop: 3 }}>
          Movimientos reales desde `financial_transaction_movements`
        </p>
      </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            ...
            <tbody>
              {cash.movimientos.map((movement) => (
                <tr key={movement.id}>
                  <td style={{ padding: '12px 12px 12px 0', borderBottom: '1px solid rgba(255,255,255,0.04)', color: '#A1A1AA' }}>{formatDateTime(movement.createdAt)}</td>
                  <td style={{ padding: '12px 12px 12px 0', borderBottom: '1px solid rgba(255,255,255,0.04)', color: '#F4F4F5', fontWeight: 500 }}>{movement.concept}</td>
                  <td style={{ padding: '12px 12px 12px 0', borderBottom: '1px solid rgba(255,255,255,0.04)', color: '#52525B', fontFamily: 'monospace', fontSize: 12 }}>{movement.reference}</td>
                  ...
                  <td style={{ padding: '12px 0', borderBottom: '1px solid rgba(255,255,255,0.04)', fontWeight: 800, color: movement.type === 'egreso' ? '#F87171' : '#34D399', fontSize: 14 }}>
